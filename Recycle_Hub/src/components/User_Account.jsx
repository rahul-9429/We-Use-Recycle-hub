    ...
    import profile from "../assets/recycling.png";
            ...
            <div className="h-screen flex flex-col items-center">
                <div className=" w-full md:w-1/2 md:mt-4 flex md:justify-evenly">
                    <div className="w-2/3 md:w-1/2 lg:w-1/3 flex justify-center items-center relative">
                        <img className=" aspect-square relative rounded-full w-1/2 md:w-2/3 z-0 object-cover border-[5px] border-emerald-400" src={profile} alt="User" />
                        <button className="absolute bottom-2 md:bottom-5 right-12 z-2 cursor-pointer bg-emerald-400 rounded-full px-1">
                            <i className='bx bx-edit text-2xl md:text-3xl text-black cursor-pointer'></i>
                ...
                <div className="h-3/4 w-3/4 md:w-1/2 mt-2 flex flex-col gap-y-2">
                    <div className="flex w-full h-1/6 justify-around items-center" id="details">
                        ...
                        <button className="text-xl italic bg-green-400 text-black px-3 h-fit rounded-md" onClick={handleEditName}><i className='bx bx-edit' id="edit"></i></button>
                    </div>
                    <div className="flex h-1/6 justify-around items-center" id="details">
                        ...
                        <button className="text-xl italic bg-green-400 text-black px-3 h-fit rounded-md" onClick={handleEditMobile}><i className='bx bx-edit'></i></button>
                    </div>
                    <div className="flex h-1/6 justify-around items-center" id="details">
                        <div className="flex flex-col w-full md:w-1/2">
                        ...
                        <button className="text-xl italic bg-green-400 text-black px-3 h-fit rounded-md" onClick={handleEditEmail}><i className='bx bx-edit'></i></button>
                    </div>
                    ...
                    <div className="flex h-1/6 justify-around items-center" id="details">
                        ...
                        <button className="text-xl italic bg-green-400 text-black px-3 h-fit rounded-md" onClick={handleEditAddress}><i className='bx bx-edit'></i></button>
                    </div>
                
                <div className="flex w-full justify-around items-center" id="details">

                <button className="bg-emerald-400 rounded-md text-sm md:text-xl max-w-[100%] px-4 text-nowrap py-1 font-semibold hover:bg-green-300 hidden md:block" onClick={logout}>Log Out</button>
                </div>
